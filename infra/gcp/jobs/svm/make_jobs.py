...
if __name__ == "__main__":
    base_path = "/users/amtseng/tfmodisco/infra/gcp/jobs/"
    template_path = os.path.join(base_path, "gkmexplain-template.yaml")
    ...
    for tf_name, task_name, fold_num in [
        ...
        ("SPI1", "SPI1_ENCSR000BGQ_GM12878", 7),
        ("SPI1", "SPI1_ENCSR000BGW_K562", 7),
        ("SPI1", "SPI1_ENCSR000BIJ_GM12891", 7),
        ("SPI1", "SPI1_ENCSR000BUW_HL-60", 7),
        ...
        out_path = os.path.join(base_path, name + ".yaml")
