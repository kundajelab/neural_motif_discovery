...
def config():
    # For binarizing profile predictions, the minimum counts for a positive
    bin_prof_min_count = 3

    # For binarizing profile predictions, the minimum probability to be positive
    bin_prof_pos_thresh = 0.015

    # For binarizing profile predictions, the maximum probability to be negative
